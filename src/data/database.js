...
// Chaque type de boisson propose des "formats de service" réalistes (verre, coupe, dose, bouteille...)
// plutôt qu'un volume brut : le premier format de la liste est le défaut (généralement 1 verre, pas 1 bouteille).
export const ALCOHOL_TYPES = [
  { id: "biere_blonde", name: "Bière blonde", emoji: "🍺", abv: 5, sucre100: 3.5, kcalBase100: 42,
    servings: [{ label: "Demi (250 ml)", ml: 250 }, { label: "Canette (330 ml)", ml: 330 }, { label: "Pinte (500 ml)", ml: 500 }, { label: "Grande bouteille (650 ml)", ml: 650 }] },
  { id: "biere_ipa", name: "Bière IPA / forte", emoji: "🍻", abv: 6.5, sucre100: 3, kcalBase100: 45,
    servings: [{ label: "Demi (250 ml)", ml: 250 }, { label: "Canette (330 ml)", ml: 330 }, { label: "Pinte (500 ml)", ml: 500 }] },
  { id: "biere_sans_alcool", name: "Bière sans alcool", emoji: "🚫🍺", abv: 0.3, sucre100: 4.5, kcalBase100: 25,
    servings: [{ label: "Canette (330 ml)", ml: 330 }, { label: "Bouteille (330 ml)", ml: 330 }] },
  { id: "cidre", name: "Cidre", emoji: "🍏", abv: 4.5, sucre100: 5, kcalBase100: 40,
    servings: [{ label: "Verre (250 ml)", ml: 250 }, { label: "Bouteille 33 (330 ml)", ml: 330 }, { label: "Bouteille (750 ml)", ml: 750 }] },
  { id: "vin_rouge", name: "Vin rouge", emoji: "🍷", abv: 13, sucre100: 0.5, kcalBase100: 10,
    servings: [{ label: "Verre (125 ml)", ml: 125 }, { label: "Grand verre (150 ml)", ml: 150 }, { label: "Demi-bouteille (375 ml)", ml: 375 }, { label: "Bouteille (750 ml)", ml: 750 }] },
  { id: "vin_blanc", name: "Vin blanc sec", emoji: "🥂", abv: 12.5, sucre100: 1.5, kcalBase100: 12,
    servings: [{ label: "Verre (125 ml)", ml: 125 }, { label: "Grand verre (150 ml)", ml: 150 }, { label: "Demi-bouteille (375 ml)", ml: 375 }, { label: "Bouteille (750 ml)", ml: 750 }] },
  { id: "vin_moelleux", name: "Vin blanc moelleux", emoji: "🍾", abv: 12, sucre100: 6, kcalBase100: 25,
    servings: [{ label: "Verre (100 ml)", ml: 100 }, { label: "Verre (125 ml)", ml: 125 }, { label: "Bouteille (750 ml)", ml: 750 }] },
  { id: "champagne", name: "Champagne / brut", emoji: "🥂", abv: 12, sucre100: 2, kcalBase100: 15,
    servings: [{ label: "Coupe (100 ml)", ml: 100 }, { label: "Flûte (125 ml)", ml: 125 }, { label: "Bouteille (750 ml)", ml: 750 }] },
  { id: "rose", name: "Vin rosé", emoji: "🌸", abv: 12.5, sucre100: 1.5, kcalBase100: 12,
    servings: [{ label: "Verre (125 ml)", ml: 125 }, { label: "Grand verre (150 ml)", ml: 150 }, { label: "Demi-bouteille (375 ml)", ml: 375 }, { label: "Bouteille (750 ml)", ml: 750 }] },
  { id: "porto", name: "Porto / vin muté", emoji: "🍇", abv: 19, sucre100: 10, kcalBase100: 45,
    servings: [{ label: "Petit verre (50 ml)", ml: 50 }, { label: "Verre (70 ml)", ml: 70 }, { label: "Bouteille (750 ml)", ml: 750 }] },
  { id: "spritz", name: "Spritz (apéritif)", emoji: "🧡", abv: 8, sucre100: 6, kcalBase100: 50,
    servings: [{ label: "Verre (200 ml)", ml: 200 }, { label: "Grand verre (300 ml)", ml: 300 }] },
  { id: "whisky", name: "Whisky", emoji: "🥃", abv: 40, sucre100: 0, kcalBase100: 2,
    servings: [{ label: "Dose sèche (30 ml)", ml: 30 }, { label: "Dose (40 ml)", ml: 40 }, { label: "Double (60 ml)", ml: 60 }, { label: "Bouteille (700 ml)", ml: 700 }] },
  { id: "vodka", name: "Vodka", emoji: "🧊", abv: 40, sucre100: 0, kcalBase100: 0,
    servings: [{ label: "Dose (40 ml)", ml: 40 }, { label: "Double (60 ml)", ml: 60 }, { label: "Bouteille (700 ml)", ml: 700 }] },
  { id: "rhum", name: "Rhum", emoji: "🏝️", abv: 40, sucre100: 0.5, kcalBase100: 2,
    servings: [{ label: "Dose (40 ml)", ml: 40 }, { label: "Double (60 ml)", ml: 60 }, { label: "Bouteille (700 ml)", ml: 700 }] },
  { id: "gin", name: "Gin", emoji: "🌿", abv: 40, sucre100: 0, kcalBase100: 0,
    servings: [{ label: "Dose (40 ml)", ml: 40 }, { label: "Double (60 ml)", ml: 60 }, { label: "Bouteille (700 ml)", ml: 700 }] },
  { id: "tequila", name: "Tequila", emoji: "🌵", abv: 38, sucre100: 0, kcalBase100: 0,
    servings: [{ label: "Shot (30 ml)", ml: 30 }, { label: "Dose (40 ml)", ml: 40 }, { label: "Bouteille (700 ml)", ml: 700 }] },
  { id: "pastis", name: "Pastis (dilué)", emoji: "💧", abv: 45, sucre100: 1, kcalBase100: 3,
    servings: [{ label: "Dose diluée (30 ml pur)", ml: 30 }, { label: "Double (50 ml pur)", ml: 50 }] },
  { id: "liqueur", name: "Liqueur / digestif", emoji: "🍯", abv: 25, sucre100: 20, kcalBase100: 90,
    servings: [{ label: "Petit verre (30 ml)", ml: 30 }, { label: "Verre (40 ml)", ml: 40 }, { label: "Bouteille (700 ml)", ml: 700 }] },
  { id: "cocktail", name: "Cocktail sucré", emoji: "🍹", abv: 15, sucre100: 10, kcalBase100: 60,
    servings: [{ label: "Verre à cocktail (150 ml)", ml: 150 }, { label: "Grand verre (200 ml)", ml: 200 }, { label: "Long drink (330 ml)", ml: 330 }] },
  { id: "custom", name: "Autre / personnalisé", emoji: "⚗️", abv: 10, sucre100: 2, kcalBase100: 20,
    servings: [{ label: "Petit verre (100 ml)", ml: 100 }, { label: "Verre (150 ml)", ml: 150 }, { label: "Bouteille (750 ml)", ml: 750 }] },
];
